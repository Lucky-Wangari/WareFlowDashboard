...
//     <div
//       key={index}
//       className={`flex flex-col ${index < 2 ? 'mr-4' : ''} mb-4 md:mb-0 md:mr-0 md:w-1/2 lg:w-auto`}
//     >
//       <Paper
//         className={`pt-4 pb-6 px-4 md:h-[400px] md:w-[688px] flex flex-col justify-between bg-white border border-gray-300 rounded-md`}
//       >
//         <div className='flex items-center justify-center pt-20'>
//           <stat.icon
//             style={{ width: '12rem', height: '12rem' }}        
...
//     <DoubleNavbar>
//       <DoubleHeader/>
//       <div className="bg-gradient-to-b from-green-300 to-yellow-200 p-8 rounded-md flex flex-col md:flex-row h-[850px] w-[1550px]">
//         <div className="flex flex-col mr-8">
//           <UnstyledButton
//             className="h-[28px] flex justify-center items-center rounded-md transition duration-200 ease-in-out hover:bg-green-100 hover:text-black"
//             onClick={() =>
...
//           </UnstyledButton>
//         </div>
//         <div className="flex-1flex flex-wrap md:flex-nowrap">
//           {stats}
//           {bikeCard}
//         </div>
//       </div>
